...
The dataset link is [here](http://beidou.s.cn.vc/Supplier).
...
| 9    | Easy        | Rich\-textured livingroom                | uniform & stable      | circle \(slow\+normal\)             | default                | [iPhoneXR_OnePlus5T_part1](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/009_01.zip) <br> [iPhoneXR_OnePlus5T_part2](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/009_02.zip) | ![009.gif](./preview_gif/009_2.gif) |
| 9_control    | Easy        | Rich\-textured livingroom                | uniform & stable      | circle \(slow\+normal\)             | default                | [iPhoneXR_OnePlus5T_MYNT_part1](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/009_control_01.zip) <br> [iPhoneXR_OnePlus5T_MYNT_part2](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/009_control_02.zip) | ![009.gif](./preview_gif/009_mynt.gif) |
...
| 11   | Easy        | Rich\-textured livingroom                | uniform & stable      | user scan simulation                | default                | [iPhoneXR_OnePlus5T_part1](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/011_01.zip) <br> [iPhoneXR_OnePlus5T_part2](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/011_02.zip) | ![011.gif](./preview_gif/011.gif) |
| 11_control   | Easy        | Rich\-textured livingroom                | uniform & stable      | user scan simulation                | default                | [iPhoneXR_OnePlus5T_MYNT_part1](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/011_control_01.zip) <br> [iPhoneXR_OnePlus5T_MYNT_part2](https://beidou-sh.oss-cn-shanghai.aliyuncs.com/near_dataset/011_control_02.zip) | ![011.gif](./preview_gif/011_mynt.gif) |
